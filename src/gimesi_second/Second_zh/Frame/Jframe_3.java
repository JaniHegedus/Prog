...
class Keret0 extends JFrame
{
    JLabel szoveg; public void Ablak()
    {
        ...
        szoveg.setOpaque(true); szoveg.setBackground(Color.YELLOW);
        ...
        szoveg.setBounds(100, 100, 200, 50); add(szoveg);
        ...
        szoveg.setBounds(200, 200, 200, 50); add(szoveg); setVisible(true);
    }
}